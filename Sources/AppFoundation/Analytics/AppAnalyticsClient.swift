...
public actor AppAnalyticsClient {
    ...
    private func flush(at timestamp: Date, force: Bool) async throws {
        ...
        let batches = try makeBatches(from: state, at: timestamp)
    ...
    private func makeBatches(from state: PersistedState, at timestamp: Date) throws -> [Batch] {
