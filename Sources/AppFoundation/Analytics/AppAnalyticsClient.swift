...
struct AppAnalyticsClientContext: Sendable {
    ...
    private static func currentDeviceFamily() -> String? {
        ...
        if normalized.hasPrefix("realitydevice") || normalized.hasPrefix("applevision") {
            return "vision"
        }
        return nil
    }
...
public actor AppAnalyticsClient {
    ...
    private func dayState(in state: PersistedState, for dayKey: String) -> DayState {
        ...
        day.deviceFamily = clientContext.deviceFamily.flatMap(Self.validNativeToken)
